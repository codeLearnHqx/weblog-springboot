...
/**
 * Knife4j 配置
 * 请求地址： http://localhost:8080/doc.html
 */
@Configuration
...
public class Knife4jAdminConfig {
    ...
    public Docket createApiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.hqx.weblog.admin.controller"))
    ...
    private ApiInfo buildApiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("稳住心态", "https://www.xxx.com", "751156604@qq.com")) // 联系人
                .version("1.0") // 版本号
                .build();
    }
}